...
echo -e "The traffic carries the signature of an attempted administrator privilege gain and as a result was blocked. The Source IP is from"$COUNTRY" ", its whitelist status is "$WHITELIST" ". It has previously been reported for various malicious activities.">>EventText.txt
