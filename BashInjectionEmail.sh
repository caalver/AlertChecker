...
echo -e "The traffic carries the signature of Bash CGI environment variable injection attempt and as a result was blocked. The Source IP is from"$COUNTRY" ", its whitelist status is "$WHITELIST" ". It has previously been reported for various malicious activities.">>EventText.txt
